...
{
    runtimeDependencies : PackageJSONPackage[];
}
...
export function updatePackageDependencies() {
    ...
    const mapFileNameToDependency: { [key: string]: PackageJSONPackage } = {};
    ...
    let findDependencyToUpdate = (url : string): PackageJSONPackage => {
