...
export async function filterPackages(packages: RunTimePackage[], platformInfo: PlatformInformation) {
    let platformPackages = filterPlatformPackages(packages, platformInfo);
    return filterAlreadyInstalledPackages(platformPackages);
}

function filterPlatformPackages(packages: RunTimePackage[], platformInfo: PlatformInformation) {
    if (packages) {
...
async function filterAlreadyInstalledPackages(packages: RunTimePackage[]): Promise<Package[]> {
