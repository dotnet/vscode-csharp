...
import { removeBOMFromBuffer, removeBOMFromString } from '../../utils/removeBom.ts';
import { IEngine } from './IEngine.ts';
import { Events, OmniSharpServer } from '../server.ts';
import DefinitionMetadataDocumentProvider from '../features/definitionMetadataDocumentProvider.ts';
import SourceGeneratedDocumentProvider from '../features/sourceGeneratedDocumentProvider.ts';
import * as vscode from 'vscode';
import OmniSharpCodeLensProvider from '../features/codeLensProvider.ts';
import OmniSharpDocumentHighlightProvider from '../features/documentHighlightProvider.ts';
import OmniSharpDocumentSymbolProvider from '../features/documentSymbolProvider.ts';
import OmniSharpHoverProvider from '../features/hoverProvider.ts';
import OmniSharpRenameProvider from '../features/renameProvider.ts';
import OmniSharpFormatProvider from '../features/formattingEditProvider.ts';
import OmniSharpWorkspaceSymbolProvider from '../features/workspaceSymbolProvider.ts';
import OmniSharpSignatureHelpProvider from '../features/signatureHelpProvider.ts';
import { OmniSharpFixAllProvider } from '../features/fixAllProvider.ts';
import OmniSharpCompletionProvider, { CompletionAfterInsertCommand } from '../features/completionProvider.ts';
import OmniSharpReferenceProvider from '../features/referenceProvider.ts';
import OmniSharpImplementationProvider from '../features/implementationProvider.ts';
import OmniSharpSemanticTokensProvider from '../features/semanticTokensProvider.ts';
import OmniSharpInlayHintProvider from '../features/inlayHintProvider.ts';
import fileOpenClose from '../features/fileOpenCloseProvider.ts';
import trackVirtualDocuments from '../features/virtualDocumentTracker.ts';
import OmniSharpCodeActionProvider from '../features/codeActionProvider.ts';
import forwardChanges from '../features/changeForwarding.ts';
import OmniSharpDefinitionProvider from '../features/definitionProvider.ts';
import reportDiagnostics, { Advisor } from '../features/diagnosticsProvider.ts';
import { LanguageMiddlewareFeature } from '../languageMiddlewareFeature.ts';
import TestManager from '../features/dotnetTest.ts';
import { OmniSharpStructureProvider } from '../features/structureProvider.ts';
