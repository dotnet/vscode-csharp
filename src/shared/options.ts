...
export class Options {
    ...
    public static Read(vscode: vscode): Options {
        ...
        const inlayHintsEnableForParameters = Options.readOption<boolean>(config, 'csharp.inlayHints.parameters.enabled', false);
        const inlayHintsForLiteralParameters = Options.readOption<boolean>(config, 'csharp.inlayHints.parameters.forLiteralParameters', false);
        const inlayHintsForObjectCreationParameters = Options.readOption<boolean>(config, 'csharp.inlayHints.parameters.forObjectCreationParameters', false);
        const inlayHintsForIndexerParameters = Options.readOption<boolean>(config, 'csharp.inlayHints.parameters.forIndexerParameters', false);
        const inlayHintsForOtherParameters = Options.readOption<boolean>(config, 'csharp.inlayHints.parameters.forOtherParameters', false);
        const inlayHintsSuppressForParametersThatDifferOnlyBySuffix = Options.readOption<boolean>(config, 'csharp.inlayHints.parameters.suppressForParametersThatDifferOnlyBySuffix', false);
        const inlayHintsSuppressForParametersThatMatchMethodIntent = Options.readOption<boolean>(config, 'csharp.inlayHints.parameters.suppressForParametersThatMatchMethodIntent', false);
        const inlayHintsSuppressForParametersThatMatchArgumentName = Options.readOption<boolean>(config, 'csharp.inlayHints.parameters.suppressForParametersThatMatchArgumentName', false);
        const inlayHintsEnableForTypes = Options.readOption<boolean>(config, 'csharp.inlayHints.types.enabled', false);
        const inlayHintsForImplicitVariableTypes = Options.readOption<boolean>(config, 'csharp.inlayHints.types.forImplicitVariableTypes', false);
        const inlayHintsForLambdaParameterTypes = Options.readOption<boolean>(config, 'csharp.inlayHints.types.forLambdaParameterTypes', false);
        const inlayHintsForImplicitObjectCreation = Options.readOption<boolean>(config, 'csharp.inlayHints.types.forImplicitObjectCreation', false);
