...
export class Options {
    ...
    public static Read(vscode: vscode): Options {
        ...
        const inlayHintsEnableForParameters = Options.readOption<boolean>(config, 'dotnet.inlineHints.enableInlineHintsForParameters', false, 'csharp.inlayHints.parameters.enabled');
        const inlayHintsForLiteralParameters = Options.readOption<boolean>(config, 'dotnet.inlineHints.enableInlineHintsForLiteralParameters',  false, 'csharp.inlayHints.parameters.forLiteralParameters');
        const inlayHintsForObjectCreationParameters = Options.readOption<boolean>(config, 'dotnet.inlineHints.enableInlineHintsForObjectCreationParameters', false, 'csharp.inlayHints.parameters.forObjectCreationParameters');
        const inlayHintsForIndexerParameters = Options.readOption<boolean>(config, 'dotnet.inlineHints.enableInlineHintsForIndexerParameters', false, 'csharp.inlayHints.parameters.forIndexerParameters');
        const inlayHintsForOtherParameters = Options.readOption<boolean>(config, 'dotnet.inlineHints.enableInlineHintsForOtherParameters', false, 'csharp.inlayHints.parameters.forOtherParameters');
        const inlayHintsSuppressForParametersThatDifferOnlyBySuffix = Options.readOption<boolean>(config, 'dotnet.inlineHints.suppressInlineHintsForParametersThatDifferOnlyBySuffix', false, 'csharp.inlayHints.parameters.suppressForParametersThatDifferOnlyBySuffix');
        const inlayHintsSuppressForParametersThatMatchMethodIntent = Options.readOption<boolean>(config, 'dotnet.inlineHints.suppressInlineHintsForParametersThatMatchMethodIntent', false, 'csharp.inlayHints.parameters.suppressForParametersThatMatchMethodIntent');
        const inlayHintsSuppressForParametersThatMatchArgumentName = Options.readOption<boolean>(config,  'dotnet.inlineHints.suppressInlineHintsForParametersThatMatchArgumentName', false, 'csharp.inlayHints.parameters.suppressForParametersThatMatchArgumentName');
        const inlayHintsEnableForTypes = Options.readOption<boolean>(config,  'csharp.inlineHints.enableInlineHintsForTypes', false, 'csharp.inlayHints.types.enabled');
        const inlayHintsForImplicitVariableTypes = Options.readOption<boolean>(config, 'csharp.inlineHints.enableInlineHintsForImplicitVariableTypes', false, 'csharp.inlayHints.types.forImplicitVariableTypes');
        const inlayHintsForLambdaParameterTypes = Options.readOption<boolean>(config, 'csharp.inlineHints.enableInlineHintsForLambdaParameterTypes', false, 'csharp.inlayHints.types.forLambdaParameterTypes');
        const inlayHintsForImplicitObjectCreation = Options.readOption<boolean>(config, 'csharp.inlineHints.enableInlineHintsForImplicitObjectCreation', false, 'csharp.inlayHints.types.forImplicitObjectCreation');
