...
export class Options {
    ...
    public static Read(vscode: vscode): Options {
        ...
        const inlayHintsEnableForParameters = Options.readOption<boolean>(config, 'csharp.inlayHints.parameters.enabled', false, 'dotnet.inlineHints.enableInlineHintsForParameters');
        const inlayHintsForLiteralParameters = Options.readOption<boolean>(config, 'csharp.inlayHints.parameters.forLiteralParameters', false, 'dotnet.inlineHints.enableInlineHintsForLiteralParameters');
        const inlayHintsForObjectCreationParameters = Options.readOption<boolean>(config, 'csharp.inlayHints.parameters.forObjectCreationParameters', false, 'dotnet.inlineHints.enableInlineHintsForObjectCreationParameters');
        const inlayHintsForIndexerParameters = Options.readOption<boolean>(config, 'csharp.inlayHints.parameters.forIndexerParameters', false, 'dotnet.inlineHints.enableInlineHintsForIndexerParameters');
        const inlayHintsForOtherParameters = Options.readOption<boolean>(config, 'csharp.inlayHints.parameters.forOtherParameters', false, 'dotnet.inlineHints.enableInlineHintsForOtherParameters');
        const inlayHintsSuppressForParametersThatDifferOnlyBySuffix = Options.readOption<boolean>(config, 'csharp.inlayHints.parameters.suppressForParametersThatDifferOnlyBySuffix', false, 'dotnet.inlineHints.suppressInlineHintsForParametersThatDifferOnlyBySuffix');
        const inlayHintsSuppressForParametersThatMatchMethodIntent = Options.readOption<boolean>(config, 'csharp.inlayHints.parameters.suppressForParametersThatMatchMethodIntent', false, 'dotnet.inlineHints.suppressInlineHintsForParametersThatMatchMethodIntent');
        const inlayHintsSuppressForParametersThatMatchArgumentName = Options.readOption<boolean>(config, 'csharp.inlayHints.parameters.suppressForParametersThatMatchArgumentName', false, "dotnet.inlineHints.suppressInlineHintsForParametersThatMatchArgumentName");
        const inlayHintsEnableForTypes = Options.readOption<boolean>(config, 'csharp.inlayHints.types.enabled', false, 'csharp.inlineHints.enableInlineHintsForTypes');
        const inlayHintsForImplicitVariableTypes = Options.readOption<boolean>(config, 'csharp.inlayHints.types.forImplicitVariableTypes', false, 'csharp.inlineHints.enableInlineHintsForImplicitVariableTypes');
        const inlayHintsForLambdaParameterTypes = Options.readOption<boolean>(config, 'csharp.inlayHints.types.forLambdaParameterTypes', false, 'csharp.inlineHints.enableInlineHintsForLambdaParameterTypes');
        const inlayHintsForImplicitObjectCreation = Options.readOption<boolean>(config, 'csharp.inlayHints.types.forImplicitObjectCreation', false, 'csharp.inlineHints.enableInlineHintsForImplicitObjectCreation');
