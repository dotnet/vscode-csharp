...
const universalEditorConfigOptionsToReaderMap: Map<string, (workspaceConfiguration: WorkspaceConfiguration) => string | undefined> = new Map([
...
function readValueIfDetectIndentationIsOff<T>(configuration: WorkspaceConfiguration, vscodeConfigName: string, defaultValue: T): T {
