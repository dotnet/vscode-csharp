...
const testData = [
    ...
    { serverOption: "csharp|inline_hints.dotnet_enable_inline_hints_for_parameters", vsCodeConfiguration: "dotnet.inlineHints.enableInlineHintsForParameters", declareInPackageJson: true},
    { serverOption: "csharp|inline_hints.dotnet_enable_inline_hints_for_literal_parameters", vsCodeConfiguration: "dotnet.inlineHints.enableInlineHintsForLiteralParameters", declareInPackageJson: true},
    { serverOption: "csharp|inline_hints.dotnet_enable_inline_hints_for_indexer_parameters", vsCodeConfiguration: "dotnet.inlineHints.enableInlineHintsForIndexerParameters", declareInPackageJson: true},
    { serverOption: "csharp|inline_hints.dotnet_enable_inline_hints_for_object_creation_parameters", vsCodeConfiguration: "dotnet.inlineHints.enableInlineHintsForObjectCreationParameters", declareInPackageJson: true},
    { serverOption: "csharp|inline_hints.dotnet_enable_inline_hints_for_other_parameters", vsCodeConfiguration: "dotnet.inlineHints.enableInlineHintsForOtherParameters", declareInPackageJson: true},
    { serverOption: "csharp|inline_hints.dotnet_suppress_inline_hints_for_parameters_that_differ_only_by_suffix", vsCodeConfiguration: "dotnet.inlineHints.suppressInlineHintsForParametersThatDifferOnlyBySuffix", declareInPackageJson: true},
    { serverOption: "csharp|inline_hints.dotnet_suppress_inline_hints_for_parameters_that_match_method_intent", vsCodeConfiguration: "dotnet.inlineHints.suppressInlineHintsForParametersThatMatchMethodIntent", declareInPackageJson: true},
    { serverOption: "csharp|inline_hints.dotnet_suppress_inline_hints_for_parameters_that_match_argument_name", vsCodeConfiguration: "dotnet.inlineHints.suppressInlineHintsForParametersThatMatchArgumentName", declareInPackageJson: true},
    { serverOption: "csharp|inline_hints.csharp_enable_inline_hints_for_types", vsCodeConfiguration: "csharp.inlineHints.enableInlineHintsForTypes", declareInPackageJson: true},
    { serverOption: "csharp|inline_hints.csharp_enable_inline_hints_for_implicit_variable_types", vsCodeConfiguration: "csharp.inlineHints.enableInlineHintsForImplicitVariableTypes", declareInPackageJson: true},
    { serverOption: "csharp|inline_hints.csharp_enable_inline_hints_for_lambda_parameter_types", vsCodeConfiguration: "csharp.inlineHints.enableInlineHintsForLambdaParameterTypes", declareInPackageJson: true},
    { serverOption: "csharp|inline_hints.csharp_enable_inline_hints_for_implicit_object_creation", vsCodeConfiguration: "csharp.inlineHints.enableInlineHintsForImplicitObjectCreation", declareInPackageJson: true},
]
