...
const testData = [
    ...
    { serverOption: "csharp|inline_hints.dotnet_enable_inline_hints_for_parameters", vsCodeConfiguration: "dotnet.inlayHints.enableInlayHintsForParameters", declareInPackageJson: true},
    { serverOption: "csharp|inline_hints.dotnet_enable_inline_hints_for_literal_parameters", vsCodeConfiguration: "dotnet.inlayHints.enableInlayHintsForLiteralParameters", declareInPackageJson: true},
    { serverOption: "csharp|inline_hints.dotnet_enable_inline_hints_for_indexer_parameters", vsCodeConfiguration: "dotnet.inlayHints.enableInlayHintsForIndexerParameters", declareInPackageJson: true},
    { serverOption: "csharp|inline_hints.dotnet_enable_inline_hints_for_object_creation_parameters", vsCodeConfiguration: "dotnet.inlayHints.enableInlayHintsForObjectCreationParameters", declareInPackageJson: true},
    { serverOption: "csharp|inline_hints.dotnet_enable_inline_hints_for_other_parameters", vsCodeConfiguration: "dotnet.inlayHints.enableInlayHintsForOtherParameters", declareInPackageJson: true},
    { serverOption: "csharp|inline_hints.dotnet_suppress_inline_hints_for_parameters_that_differ_only_by_suffix", vsCodeConfiguration: "dotnet.inlayHints.suppressInlayHintsForParametersThatDifferOnlyBySuffix", declareInPackageJson: true},
    { serverOption: "csharp|inline_hints.dotnet_suppress_inline_hints_for_parameters_that_match_method_intent", vsCodeConfiguration: "dotnet.inlayHints.suppressInlayHintsForParametersThatMatchMethodIntent", declareInPackageJson: true},
    { serverOption: "csharp|inline_hints.dotnet_suppress_inline_hints_for_parameters_that_match_argument_name", vsCodeConfiguration: "dotnet.inlayHints.suppressInlayHintsForParametersThatMatchArgumentName", declareInPackageJson: true},
    { serverOption: "csharp|inline_hints.csharp_enable_inline_hints_for_types", vsCodeConfiguration: "csharp.inlayHints.enableInlayHintsForTypes", declareInPackageJson: true},
    { serverOption: "csharp|inline_hints.csharp_enable_inline_hints_for_implicit_variable_types", vsCodeConfiguration: "csharp.inlayHints.enableInlayHintsForImplicitVariableTypes", declareInPackageJson: true},
    { serverOption: "csharp|inline_hints.csharp_enable_inline_hints_for_lambda_parameter_types", vsCodeConfiguration: "csharp.inlayHints.enableInlayHintsForLambdaParameterTypes", declareInPackageJson: true},
    { serverOption: "csharp|inline_hints.csharp_enable_inline_hints_for_implicit_object_creation", vsCodeConfiguration: "csharp.inlayHints.enableInlayHintsForImplicitObjectCreation", declareInPackageJson: true},
]
