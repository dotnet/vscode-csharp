...
async function getScopeToFilePathRegistry() {
    ...
    const htmlRawGrammar = await loadRawGrammar(
        'test/razor/razorTests/Microsoft.AspNetCore.Razor.VSCode.Grammar.Test/embeddedGrammars/html.tmLanguage.json'
    );
    const cssRawGrammar = await loadRawGrammar(
        'test/razor/razorTests/Microsoft.AspNetCore.Razor.VSCode.Grammar.Test/embeddedGrammars/css.tmLanguage.json'
    );
    ...
    const csharpRawGrammar = await loadRawGrammar(
        'test/razor/razorTests/Microsoft.AspNetCore.Razor.VSCode.Grammar.Test/embeddedGrammars/csharp.tmLanguage.json'
    );
