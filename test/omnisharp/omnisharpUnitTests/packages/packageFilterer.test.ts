...
import type { AbsolutePathPackage as AbsolutePathPackageType } from '../../../../src/packageManager/absolutePathPackage';
...
const { PlatformInformation } = await import('../../../../src/shared/platform');
const { getNotInstalledPackagesForPlatform } = await import('../../../../src/packageManager/packageFilterer');
const { AbsolutePathPackage } = await import('../../../../src/packageManager/absolutePathPackage');
