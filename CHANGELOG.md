...
## 1.24.3
* Fix OmniSharp not found issue on Mono ([#5140](https://github.com/OmniSharp/omnisharp-roslyn/issues/5140), PR: [##5141](https://github.com/OmniSharp/omnisharp-vscode/pull/#5141))
