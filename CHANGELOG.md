...
* Update Roslyn to 5.11.0-1.26424.9 (PR: [#](https://github.com/dotnet/vscode-csharp/pull/))
  ...
  * Avoid reparenting `Nullable.get_Value` to an error type (PR: [#84941](https://github.com/dotnet/roslyn/pull/84941))
  ...
  * Avoid reordering by-ref locals (PR: [#84937](https://github.com/dotnet/roslyn/pull/84937))
  * Add opt-in ~/ asset-path expansion for Razor components (compiler) (PR: [#84796](https://github.com/dotnet/roslyn/pull/84796))
  * Improve recovery for repeated partial type modifiers (PR: [#84934](https://github.com/dotnet/roslyn/pull/84934))
  ...
  * Caching compiler: support binary additional texts (PR: [#84916](https://github.com/dotnet/roslyn/pull/84916))
  ...
  * Fix RestrictChildren incorrectly flagging valid child tags (PR: [#84870](https://github.com/dotnet/roslyn/pull/84870))
  * ShadowCopyAnalyzerPathResolver: Use cache to amortize cost of AV scans (PR: [#84765](https://github.com/dotnet/roslyn/pull/84765))
  * Revert "Use SQLite3MC (#84140)" and update SourceGear.Sqlite3 to 3.53.4 (PR: [#84692](https://github.com/dotnet/roslyn/pull/84692))
  * Add C# 15 language version (PR: [#84799](https://github.com/dotnet/roslyn/pull/84799))
  * Unsafe evolution: allow await in unsafe context (PR: [#84616](https://github.com/dotnet/roslyn/pull/84616))
  * Do not offer introduce parameter for incomplete calls (PR: [#84769](https://github.com/dotnet/roslyn/pull/84769))
  * Keep a fallback component's derived tag helpers during discovery (PR: [#84818](https://github.com/dotnet/roslyn/pull/84818))
  * Restore public GetCSharpDocument() and GeneratedCode for runtime compilation (PR: [#84813](https://github.com/dotnet/roslyn/pull/84813))
  ...
  * Clone the IR tree so we don't have to re-lower from syntax. (PR: [#84715](https://github.com/dotnet/roslyn/pull/84715))
  * Skip redundant discovery and declaration lowering when replaying a Razor document (PR: [#84698](https://github.com/dotnet/roslyn/pull/84698))
  * Consume split Razor declarations through pre-compilation source output (PR: [#84670](https://github.com/dotnet/roslyn/pull/84670))
  * Run Razor decl C# lowering before tag-helper discovery (classify-first component split) (PR: [#84605](https://github.com/dotnet/roslyn/pull/84605))
  * Split Razor components into decl/impl before tag-helper resolution (PR: [#84577](https://github.com/dotnet/roslyn/pull/84577))
  * Query impl and decl documents in Razor code lens and document symbols (PR: [#84586](https://github.com/dotnet/roslyn/pull/84586))
  * Move Razor to DocumentUri (PR: [#84370](https://github.com/dotnet/roslyn/pull/84370))
  ...
  * Sonic 3.2: Activate the decl/impl split (PR: [#83887](https://github.com/dotnet/roslyn/pull/83887))
  * Sonic 3.1: Generate Decl Files (PR: [#83688](https://github.com/dotnet/roslyn/pull/83688))
