...
* Bump Roslyn to 5.0.0-1.25326.2 (PR: pending)
  ...
  * Revert "Ensure the LSP server is loaded after a solution is closed" (PR: [#79125](https://github.com/dotnet/roslyn/pull/79125))
  * Have RoslynAnalyzers reference shared utilities/extensions from Roslyn layer itself. (PR: [#79030](https://github.com/dotnet/roslyn/pull/79030))
  * Keep parse options in the result of `SyntaxFactory.Parse*` methods (PR: [#78790](https://github.com/dotnet/roslyn/pull/78790))
  * Precursor to share code with RoslynAnalyzers. (PR: [#79117](https://github.com/dotnet/roslyn/pull/79117))
  * Remove dead code (PR: [#79116](https://github.com/dotnet/roslyn/pull/79116))
  * Improve performance of fix all that only changes syntax (PR: [#79108](https://github.com/dotnet/roslyn/pull/79108))
  * Clean up KeyValuePair polyfills (PR: [#78872](https://github.com/dotnet/roslyn/pull/78872))
  * Simplify fix all API (PR: [#79110](https://github.com/dotnet/roslyn/pull/79110))
  * Ensure the LSP server is loaded after a solution is closed (PR: [#79048](https://github.com/dotnet/roslyn/pull/79048))
  * Merge main (PR: [#79107](https://github.com/dotnet/roslyn/pull/79107))
  * Automatically apply fixes to copilot changes (PR: [#79067](https://github.com/dotnet/roslyn/pull/79067))
  * Fix unnecessary dictionary allocations in semantic token classification (PR: [#79105](https://github.com/dotnet/roslyn/pull/79105))
  * Convert to regular constructor for partial types (PR: [#79092](https://github.com/dotnet/roslyn/pull/79092))
  * Fix layering of C# formatting options (PR: [#79083](https://github.com/dotnet/roslyn/pull/79083))
  * Fix layering of semantic model reuse service (PR: [#79086](https://github.com/dotnet/roslyn/pull/79086))
  * Make option definition more strongly typed (PR: [#79084](https://github.com/dotnet/roslyn/pull/79084))
  * Fix roslyn test modifiers in semantic tokens (PR: [#79070](https://github.com/dotnet/roslyn/pull/79070))
  * Remove references to RoslynAnalyzers from Roslyn (PR: [#79080](https://github.com/dotnet/roslyn/pull/79080))
  * Move more code into VB shared source (PR: [#79081](https://github.com/dotnet/roslyn/pull/79081))
  * Stack Trace Explorer: Cancel previous navigation on new navigation (PR: [#79069](https://github.com/dotnet/roslyn/pull/79069))
  * Address feedback from #78648 (PR: [#78880](https://github.com/dotnet/roslyn/pull/78880))
