...
* Update Roslyn to 5.6.0-2.26163.11 (PR: [#](https://github.com/dotnet/vscode-csharp/pull/))
  ...
  * Report progress when we're doing the auto-load of the project (PR: [#82700](https://github.com/dotnet/roslyn/pull/82700))
  * Implement SynthesizedBackingFieldSymbolBase.TryGetFirstLocation (PR: [#82679](https://github.com/dotnet/roslyn/pull/82679))
