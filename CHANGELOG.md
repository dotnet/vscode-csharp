...
* Update Roslyn to 5.9.0-1.26318.9 (PR: [#](https://github.com/dotnet/vscode-csharp/pull/))
  ...
  * Add support for external Test Discovery language server service (PR: [#84178](https://github.com/dotnet/roslyn/pull/84178))
  * Reduce IntermediateNodeCollection backing List allocations (PR: [#84165](https://github.com/dotnet/roslyn/pull/84165))
  * Fix CodeLens missing references to extension block methods (PR: [#84157](https://github.com/dotnet/roslyn/pull/84157))
  * Fix EnC logging MEF export (PR: [#84163](https://github.com/dotnet/roslyn/pull/84163))
  * Log LSP server info at startup (PR: [#84168](https://github.com/dotnet/roslyn/pull/84168))
  * Report CS9361 for wrapped stackalloc expressions under SkipLocalsInit (PR: [#84040](https://github.com/dotnet/roslyn/pull/84040))
  * Implement approved public API for closed class feature (PR: [#84045](https://github.com/dotnet/roslyn/pull/84045))
  * Unions: support inheritance of TryGetValue methods in member provider interface (PR: [#84122](https://github.com/dotnet/roslyn/pull/84122))
  * Reduce allocations during default razor intermediate node lowering phase (PR: [#84154](https://github.com/dotnet/roslyn/pull/84154))
  ...
  * Hot Reload: Temporarily disable project-level analysis (PR: [#81729](https://github.com/dotnet/roslyn/pull/81729))
  * Eliminate DescendantNodes() allocation in VisitDirective (PR: [#84130](https://github.com/dotnet/roslyn/pull/84130))
  * Unsafe evolution: explicit layout (PR: [#83974](https://github.com/dotnet/roslyn/pull/83974))
  * Replace string.Compare == 0 patterns with Equals/StartsWith calls (PR: [#84036](https://github.com/dotnet/roslyn/pull/84036))
  * Unsafe evolution: unsafe expressions (PR: [#84012](https://github.com/dotnet/roslyn/pull/84012))
  * DefaultFileChangeWatcher fixes - share/fix leaks/assert (PR: [#84143](https://github.com/dotnet/roslyn/pull/84143))
  * Refactor LSP server logging to remove singleton lsp instance (PR: [#84001](https://github.com/dotnet/roslyn/pull/84001))
  * Unions: support inheritance of HasValue property in member provider interface (PR: [#84088](https://github.com/dotnet/roslyn/pull/84088))
  * Unions: support inheritance of Value property in member provider interface (PR: [#84070](https://github.com/dotnet/roslyn/pull/84070))
  * Unions: support inheritance of Create methods (PR: [#83991](https://github.com/dotnet/roslyn/pull/83991))
