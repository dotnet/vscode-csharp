...
* Update Roslyn to 5.9.0-1.26319.6 (PR: [#9457](https://github.com/dotnet/vscode-csharp/pull/9457))
  ...
  * Merge "extension indexers" into `main` branch (PR: [#84200](https://github.com/dotnet/roslyn/pull/84200))
  * Extension indexers: receiver handling and tests for remaining complex assignments (PR: [#83587](https://github.com/dotnet/roslyn/pull/83587))
  * Extension indexers: fix receiver handling for implicit indexers in compound assignment (PR: [#83553](https://github.com/dotnet/roslyn/pull/83553))
  * Extension indexers: fix receiver handling for implicit indexers being set (PR: [#83505](https://github.com/dotnet/roslyn/pull/83505))
  * Extension indexers: fix receiver handling for implicit indexers being read (PR: [#83227](https://github.com/dotnet/roslyn/pull/83227))
  * Extension indexers: string and array scenarios (PR: [#83041](https://github.com/dotnet/roslyn/pull/83041))
  * Extension indexers: allow classic extension Slice method (PR: [#82836](https://github.com/dotnet/roslyn/pull/82836))
  * Extension indexers: implicit indexers in list-patterns (PR: [#82757](https://github.com/dotnet/roslyn/pull/82757))
  * Extension indexers: indexing with implicit indexers (PR: [#82453](https://github.com/dotnet/roslyn/pull/82453))
  * Extension indexers: avoid assignment to BoundSequence (PR: [#82296](https://github.com/dotnet/roslyn/pull/82296))
  * Extension indexers: interpolation handler follow-ups (PR: [#82218](https://github.com/dotnet/roslyn/pull/82218))
  * Extension indexers: disallow dynamic arguments (PR: [#82220](https://github.com/dotnet/roslyn/pull/82220))
  * Extension indexers: nullability analysis (PR: [#81971](https://github.com/dotnet/roslyn/pull/81971))
  * Extension indexers: bind CREF (PR: [#82012](https://github.com/dotnet/roslyn/pull/82012))
  * Extension indexers: allow and resolve extension indexers (PR: [#81607](https://github.com/dotnet/roslyn/pull/81607))
