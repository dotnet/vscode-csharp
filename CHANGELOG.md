...
* Update Razor to 10.4.0-preview.26262.9 (PR: [#9293](https://github.com/dotnet/vscode-csharp/pull/9293))
  ...
  * Add support for writing HTML literals using UTF-8 strings (PR: [#83457](https://github.com/dotnet/roslyn/pull/83457))
  ...
  * Unify namespaces in Razor formatting (PR: [#83582](https://github.com/dotnet/roslyn/pull/83582))
