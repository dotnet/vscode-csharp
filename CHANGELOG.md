...
* Update Roslyn to 5.12.0-1.26452.1 (PR: [#9725](https://github.com/dotnet/vscode-csharp/pull/9725))
  ...
  * Consider the type of file change when we process file changes (PR: [#85091](https://github.com/dotnet/roslyn/pull/85091))
  * Send $/progress notifications with named arguments (PR: [#85076](https://github.com/dotnet/roslyn/pull/85076))
