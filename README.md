...
* Debugging support for .NET Core (CoreCLR). NOTE: Mono debugging is not support. Desktop CLR debugging has [limited support](https://github.com/OmniSharp/omnisharp-vscode/wiki/Desktop-.NET-Framework).
